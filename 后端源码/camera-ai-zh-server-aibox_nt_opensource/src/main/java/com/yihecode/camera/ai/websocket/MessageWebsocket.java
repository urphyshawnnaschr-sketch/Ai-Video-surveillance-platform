...
/**
* first page Bullet Window Message socket
*
* @author zhoumingxing
...
@Slf4j
@Component
@ServerEndpoint(value = "/message/{satoken}")
...
//log.info("message socket close token {}, session {}", satoken, session);
//
...
//log.info("message socket error, {}", session);
try {
session.close();
} catch (Exception e) {
e.printStackTrace();
