<template>
  <div>
    <div style="padding: 0 10px">
      <el-button type="primary" @click="esbEdit">{{
        $t("feishu.esb_config.0e5yvd")
      }}</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      columns: Object.freeze([
        ...
        {
          key: "webhook",
          title: this.$t("feishu.form_new.y32326"),
          align: "left",
        },
        {
          key: "state",
  ...
  methods: {
    ...
    getSocialHookList() {
      this.loading = true;
      socialHookList({ type: 0 }).then((res) => {
        this.loading = false;
