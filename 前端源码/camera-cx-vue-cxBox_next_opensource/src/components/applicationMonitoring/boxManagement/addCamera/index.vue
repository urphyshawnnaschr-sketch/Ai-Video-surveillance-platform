      ...
      <div class="camera-dialog">
        <div class="camera-left">
          <el-form label-width="120px">
            ...
            <el-form-item :label="$t('addcamera.index.f5gcee')">
              <el-select
            ...
            <el-form-item>
              ...
              >
                ...
                <el-table-column
                  :label="$t('addcamera.index.kc7k18')"
                  width="60"
                  align="center"
                >
                  <template slot-scope="scope">
                ...
                <el-table-column
                  :label="$t('addcamera.index.19x4c2')"
                  align="center"
                >
                  <template slot-scope="scope">
                    <!-- <div
  ...
  methods: {
    ...
    saveData() {
      ...
      const params = {
        ...
        locationType: 1,
        soundColumnId: this.detail.soundColumnId
          ? this.detail.soundColumnId
          : 0,
      };
