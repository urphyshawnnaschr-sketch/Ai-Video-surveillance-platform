              ...
              >
                ...
                >
                  <div class="picture-style">
                    <img
                      style="width: 100%"
                      :src="item.webUrl + '/report/stream?id=' + item.id"
                      alt=""
                    />
                  </div>
                  <div class="alarm-msg">
                    <div class="msgLine">
                      {{ $t("common.alarmTime") }}：{{ item.alarmTime }}
                    </div>
                    <div class="msgLine">{{$t('components.alarmlistpicture.g71a97')}}{{ item.cameraName }}</div>
                    <div class="msgLine">{{$t('components.alarmlistpicture.8s4f14')}}{{ item.algorithmName }}
                    </div>
                  </div>
                </div>
              </vue-seamless-scroll>
